...
export default function AccountRejectedPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/v2/user')
      .then(res => res.json())
      .then(data => { setRejectionReason(data.rejectionReason || null); setIsPageLoading(false) })
          ...
          <div className="w-full max-w-md text-center">
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="space-y-2">
                <h1 className="text-2xl font-bold">Account Request Not Approved</h1>
                <p className="text-muted-foreground">Your request to join has not been approved by the administrator.</p>
              </div>
              {rejectionReason && (
